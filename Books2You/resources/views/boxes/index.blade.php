...
<div class="container">
    <div class="text-center p-4 p-lg-5">
        ...
        <h1 class="fw-bold mb-4">Browse all of our Genres,<br />And choose your Box Size</h1>
    </div>
</div>
<div class="container">
    <div class="row">
            ...
            <div class="col-md-4">
                <div id="box-card" class="p-4 text-center shadow-lg m-5 rounded-5 box-card">
                    ...
                    <div class="card-footer">
                        <h3 class="fw-bold p-0 m-0 text-success">€{{ $box->Price }}.00</h3>
                        <a class="btn btn-primary btn-box-home mt-4" role="button" href="{{ route('subscribe.confirm', $box) }}">Subscribe Now</a>
