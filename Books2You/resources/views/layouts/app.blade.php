...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm navbg">
            <div class="container">
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <a href="{{ route('admin.dashboard') }}" class="btn ">Admin Dashboard</a>
                                     @else
                                 <a href="{{ route('dashboard') }}" class="btn ">Customer Dashboard</a>
                                    @endif
...
<footer class="text-center">
        <div class="container text-muted py-4 py-lg-5 stickybottom">
