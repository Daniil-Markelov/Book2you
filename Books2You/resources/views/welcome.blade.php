                    ...
                    <div class="container h-100">
                        <div class="row h-100">
                            <div class="col-md-10 col-xl-8 text-center d-flex d-sm-flex d-md-flex justify-content-center align-items-center mx-auto justify-content-md-start align-items-md-center justify-content-xl-center">
                                <div>
                                    <h2 class="text-uppercase fw-bold mb-3"><img class="img-fluid" src="{{ asset('images/box_2.jpg') }}" width="634" height="634" /><br />Curated, crafted, and delivered to you.<br /><br /></h2>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6"><img class="img-fluid" src="{{ asset('images/small_box.jpg') }}" />
                <h1 class="text-center">Regular Box Box</h1>
            ...
            <div class="col-md-6"><img class="img-fluid" src="{{ asset('images/big_box.jpg') }}" />
                <h1 class="text-center">Big Book Box</h1>
